...
Выберите дату: <input type="text" value="<?//=date('d.m.Y')?>" onchange="SendAjax(this.value);" name="calendar" id="calendar" onclick="BX.calendar({node: this, field: this, bTime: false});">
